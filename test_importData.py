...
test_data1 = pd.DataFrame(data={'time': [0, 27.775],
                                'voltage': [-0.145, 0.72]},
                          index=[0, 9999])
test_data5 = pd.DataFrame(data={'time': [0, 27.775],
                                'voltage': [-0.15, -0.37]},
                          index=[0, 9999])
test_data17 = pd.DataFrame(data={'time': [0, 13.887],
                                 'voltage': [-0.15, -0.175]},
                           index=[0, 9999])
...
test_data29 = pd.DataFrame(data={'time': [0, 13.887],
                           ...
                           index=[0, 9999])
test_data31 = pd.DataFrame(data={'time': [0, 13.887],
                                 'voltage': [-0.0625, -0.0875]},
                           index=[0, 9999])
test_data32 = pd.DataFrame(data={'time': [0, 13.887],
                                 'voltage': [-243.75, -268.75]},
                           index=[0, 9999])
